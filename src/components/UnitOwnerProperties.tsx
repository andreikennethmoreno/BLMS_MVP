...
import { Property } from "../types";
    ...
    const UnitOwnerProperties: React.FC = () => {
      ...
      const statusCounts = {
        ...
        pending: ownerProperties.filter(
          (p: Property) => p.status === "pending_review"
        ).length,
        approved: ownerProperties.filter((p: Property) => p.status === "approved")
          .length,
        rejected: ownerProperties.filter((p: Property) => p.status === "rejected")
          .length,
      };
              ...
              {ownerProperties.length === 0 ? (
                <div className="text-center py-12">
                  ...
                  <p className="text-sm text-gray-400">
                    Add your first property to start earning from bookings
                  </p>
                </div>
              ) : (
                        ...
                        <div className="flex items-center justify-between mb-4">
                          <div>
                            ...
                            <div className="font-semibold text-emerald-600">
                              ...
                              {property.baseRate &&
                                property.finalRate &&
                                property.baseRate !== property.finalRate && (
                          ...
                          <div className="mt-4">
                            <PropertyAppealSystem
                              ...
                              onAppealSubmitted={() => {
                                ...
                                alert(
                                  "Appeal submitted successfully! Your property is now pending review."
                                );
                              }}
                            />
                          </div>
                    ...
                    <div>
                      ...
                      <div className="space-y-3">
                          ...
                          selectedProperty.finalRate !==
                            ...
                            <div>
                              ...
                              <p className="text-2xl font-bold text-emerald-600">
                                ${selectedProperty.finalRate}/night
                              </p>
                            </div>
                          )}
                        ...
                        <div>
                          ...
                          <div className="mt-2">
                            <span
                              className={`inline-flex items-center space-x-1 px-3 py-2 rounded-lg text-sm font-medium ${getStatusColor(
                                selectedProperty.status
                              )}`}
                            >
                              {getStatusIcon(selectedProperty.status)}
                        ...
                        {selectedProperty.status === "approved" && (
                          <div className="mt-4 p-4 bg-emerald-50 border border-emerald-200 rounded-lg">
                            ...
                            <p className="text-emerald-800 text-sm">
                              Your property is now visible to customers and
                ...
                <div className="p-6">
                  ...
                  <PropertyEditSystem
                    ...
                    onEditSubmitted={() => {
                      ...
                      alert(
                        "Property updated successfully! It will be reviewed again before going live."
                      );
                    }}
